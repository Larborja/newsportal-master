...
import 'satPostDetails.dart';

class sat_AllNews extends StatefulWidget {
  @override
  _sat_AllNewsState createState() => new _sat_AllNewsState();
}

class _sat_AllNewsState extends State<sat_AllNews> {
                               ...
                               new Container(
                                 child: Align(
                                   ...
                                   child: new Container(
                                     ...
                                     child: InkWell(
                                       onTap: (){
                                         Navigator.of(context).push(new MaterialPageRoute(builder: (context)=>SatPostDetails(snapshot![index])));
                                       },
